...
<%
    ...
    if (currentStatus == null) currentStatus = "全部";
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
    <div class="header">
        <h2>📦 我的订单</h2>
        <a href="${pageContext.request.contextPath}/pages/product/index.jsp" class="back-btn">← 返回</a>
    </div>

    <!-- Tab 切换 -->
    <div class="tabs">
        <a href="${pageContext.request.contextPath}/order/list?status=全部"
           class="<%= "全部".equals(currentStatus) ? "active" : "" %>">全部</a>
